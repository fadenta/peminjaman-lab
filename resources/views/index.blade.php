...
@section('container')
    ...
    <section id="home" class="hero-area bg_cover">
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 offset-xl-7 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="hero-content">
                        <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">Sistem Peminjaman Laboratorium
                        </h2>
                        <p class="wow fadeInUp" data-wow-delay=".4s">Selamat datang di Website Peminjaman Laboratorium Terbaik di
                            Universitas Duta Bangsa. Temukan, pesan, dan gunakan lab kampus dengan mudah</p>
                        <div class="hero-btns">
        ...
        <div class="hero-left">
            <img src="assets/images/komputer.jpeg" alt="">
